...
func (w *wallet) SignTx(account accounts.Account, tx *types.Transaction, chainID *big.Int, isIichain bool) (*types.Transaction, error) {
	w.stateLock.RLock() // Comms have own mutex, this is for the state fields
	defer w.stateLock.RUnlock()

	if isIichain {
		return nil, errors.New("Signing Iichain transactions with a USB wallet not yet supported")
	}
